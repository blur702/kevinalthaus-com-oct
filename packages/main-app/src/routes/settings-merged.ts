...
router.put('/site', csrfProtection, settingsRateLimit as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
...
router.get('/security', (_req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
      const settings = await getSettings([
...
router.put('/security', csrfProtection, settingsRateLimit as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
...
router.get('/email', (_req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
      const settings = await getSettings([
...
router.put('/email', csrfProtection, settingsRateLimit as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
...
// Test email endpoint
router.post('/email/test', csrfProtection, emailRateLimit as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
...
router.get('/api-keys', (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
      const userId = req.user!.userId!;
...
router.post('/api-keys', csrfProtection, apiKeyCreationRateLimit as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
...
router.delete('/api-keys/:id', csrfProtection, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
      const { id } = req.params;
      const userId = req.user!.userId!;
...
router.post('/cache/reload', csrfProtection as RequestHandler, (req: AuthenticatedRequest, res: Response): void => {
  void (async (): Promise<void> => {
    try {
      const userId = req.user!.userId!;
